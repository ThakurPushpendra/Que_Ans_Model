...
def analyze_video():
    ...
    while cap.isOpened():
        ...
        frame_with_emotions = face_emotion_detector.detect_emotions(resized_frame)
        ...
        if not audio_extracted:
            ...
            audio_thread = Thread(target=convert_audio_to_text, args=(audio_file, r))
            audio_thread.start()
...
def convert_audio_to_text(audio_file, recognizer):
